...
farming_vegetableconf.props["Cannabis"].maxVeg = 1;
farming_vegetableconf.props["Cannabis"].minVegAutorized = 1;
farming_vegetableconf.props["Cannabis"].maxVegAutorized = 1;
