...
-- Icons
farming_vegetableconf.icons["Cannabis"] = "cd_farming_cnbs_7";
...
farming_vegetableconf.props["Cannabis"].texture = "cd_farming_cnbs_7";
...
farming_vegetableconf.props["Cannabis"].maxVeg = 4;
farming_vegetableconf.props["Cannabis"].minVegAutorized = 4;
farming_vegetableconf.props["Cannabis"].maxVegAutorized = 4;
...
"cd_farming_cnbs_5",
"cd_farming_cnbs_6",
"cd_farming_cnbs_7", -- mature: hasVegetable = true & hasSeed = true
"cd_farming_cnbs_8", -- rotten
}